 ...
 */
public class TestDomElements extends JFrame {
    ...
    private TestDomElements() throws Exception {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        File categories = Word2VecExample.txt.resolve("categories.txt").toFile();
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            Logger.getLogger(TestDomElements.class.getName()).log(Level.SEVERE, null, ex);
        }
        TestDomElements test = new TestDomElements();
