...
public class PrepareWordVector {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String filePath = new File(Word2VecExample.build.toString(), "all.txt").getAbsolutePath();
        ...
        WordVectorSerializer.writeWordVectors(vec.lookupTable(), new File(Word2VecExample.build.toString(), "DomWordVector.txt").getAbsolutePath());
    }
}
