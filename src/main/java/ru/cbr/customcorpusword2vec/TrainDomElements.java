...
public class TrainDomElements {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DATA_PATH = Word2VecExample.txt.toFile().getAbsolutePath();
        ...
        wordVectors = WordVectorSerializer.readWord2VecModel(new File(Word2VecExample.build.toString(), "DomWordVector.txt").getAbsolutePath());
